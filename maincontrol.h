...
public:
    ...
    SiemensPLCDeviceManager * GetPoint_SiemensPLCDevice();
...
signals:
    ...
    //plc设备连接状态
    void sig_PLCConnectState(int n_Station, bool b_Connect);
    ...
    void sig_ReadPLCData_1(PLC_DATAAREA_1 PLCData);

    void sig_ReadPLCData_2(PLC_DATAAREA_2 PLCData);

    void sig_ReadPLCData_3(PLC_DATAAREA_3 PLCData);
